 ...
 *
 * <p>
 * The expected JSON structure to represent a Completion suggest search
 * statement is as follows:
 *
 * { "suggest-vnf" : { "text" : "VNFs", "completion" : { "field" :
 * "entity_suggest", "size": 1 } } }
 */
public class SuggestionStatement {
	 ...
	 * that is understandable by ElasticSearch and is suitable for inclusion in
