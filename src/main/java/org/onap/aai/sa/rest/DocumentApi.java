...
public class DocumentApi {
	...
	public Response processPut(String content, HttpServletRequest request, HttpHeaders headers,
		...
		try {
			...
			String resourceVersion = headers.getRequestHeaders().getFirst(REQUEST_HEADER_RESOURCE_VERSION);
	...
	public Response processSearchWithGet(String content, HttpServletRequest request, HttpHeaders headers, String index,
	...
	public Response queryWithGetWithPayload(String content, HttpServletRequest request, HttpHeaders headers,
	...
	public Response processSearchWithPost(String content, HttpServletRequest request, HttpHeaders headers, String index,
	...
	public Response processSuggestQueryWithPost(String content, HttpServletRequest request, HttpHeaders headers,
			String index, DocumentStoreInterface documentStore) {
	 ...
	 *
	 * @param index
	 *            - The index to be queried against.
	 * @param content
	 *            - The payload containing the query structure.
	 * @param request
	 *            - The HTTP request.
	 * @param headers
	 *            - The HTTP headers.
	 ...
	 */
	private Response processQuery(String index, String content, HttpServletRequest request, HttpHeaders headers,
			DocumentStoreInterface documentStore) {
	 ...
	 * @return - A standard HTTP response.
	 */
	private Response processSuggestQuery(String index, String content, HttpServletRequest request, HttpHeaders headers,
			DocumentStoreInterface documentStore) {
	...
	/**
	 * Checks the supplied HTTP headers to see if we should allow the underlying
	 * document store to implicitly create the index referenced in a document
	 * PUT or POST if it does not already exist in the data store.
	 * 
	 * @param headers
	 *            - The HTTP headers to examine.
	 * 
	 * @return - true if the headers indicate that missing indices should be
	 *         implicitly created, false otherwise.
	 */
	private boolean implicitlyCreateIndex(HttpHeaders headers) {

		boolean createIndexIfNotPresent = false;
		String implicitIndexCreationHeader = headers.getRequestHeaders()
				.getFirst(REQUEST_HEADER_ALLOW_IMPLICIT_INDEX_CREATION);
